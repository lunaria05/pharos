      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isLoading && (
          <div className="text-center py-16">
            <AiOutlineLoading3Quarters className="animate-spin text-6xl mx-auto mb-6 text-[#f97028]" />
            <p className="text-2xl font-rubik font-bold text-gray-700">Loading leaderboard...</p>
            <p className="text-lg font-rubik text-gray-500 mt-2">Fetching data from smart contracts</p>
          </div>
        )}
