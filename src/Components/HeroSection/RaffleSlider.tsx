      ...
      <div className="relative w-full overflow-hidden border-b-4 border-black bg-white py-14 xs:py-24">
        ...
        <div className="flex justify-center items-center px-3 xs:px-4 bp-xs:px-6 md:px-8 lg:px-12">
          <div className="flex items-center justify-center py-20">
            <AiOutlineLoading3Quarters className="animate-spin text-pharos-orange text-4xl mr-4" />
            <span className="text-xl font-rubik font-semibold text-gray-700">Loading live raffles...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex justify-center items-center px-3 xs:px-4 bp-xs:px-6 md:px-8 lg:px-12">
        ...
        >
          {liveRaffles.map((raffle, index) => (
            <div key={raffle.address} className="w-full flex-shrink-0 flex justify-center">
